...
<head id="Head1" runat="server">
    ...
    function startRequest(arg,context)
    {
        <%= ClientScript.GetCallbackEventReference(this,"arg","getServerResponse","context")%>;
    }
    
    function getServerResponse(arg,context)
    {
           document.getElementById ("divServerMsg").innerHTML=arg;
    }
    </script>
</head>
<body>
